  ...
  <header>
          <nav class="shadow navbar navbar-expand-md navbar-dark fixed-top bg-dark" >
                  ...
                  <div class="collapse navbar-collapse" id="navbarCollapse">
                          <div class="d-sm-none d-md-block mx-auto mt-2 mt-md-0"> 
              ...
              <div class="col-lg-4 col-sm-auto col-md-auto">
                ...
                <div class='card mt-2 shadow p' >
                        <div class='card-body' style='text-align:center'>
                                         <div>  
                                          <img src='assets/profileimages/".$personal['user_profileimg']."'  class='rounded-circle' alt='Forest' width='150px' height='150px'>
                                         </div>  
                                         <hr>              
                                          <div class='row mx-auto'>
